...
Z::Z(sf::Texture& t, int colorNum, sf::Vector2f pos):
	Shapes(pos)
{
	...
	m_square[2].setTheOrigin(sf::Vector2f(-S_SIZE * 0.5, S_SIZE * 1.5));

	m_square[3].setTheOrigin(sf::Vector2f(S_SIZE * 1.5, S_SIZE * 0.5));
...
//---------------------------
void Z::setPosition(sf::Vector2f pos) {
